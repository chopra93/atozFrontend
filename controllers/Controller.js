...
$scope.emi = function(){
  $http.get('http://ec2-34-216-106-44.us-west-2.compute.amazonaws.com:8080/atoz/v1/emi?p='+$scope.principal+'&r='+$scope.rate+'&t='+$scope.duration+'&type='+$scope.monthOrYear).success(function(response){
...
$scope.fd = function(principal,rate,duration,monthOrYear,compoundingFreq){
  $http.get('http://ec2-34-216-106-44.us-west-2.compute.amazonaws.com:8080/v1/fd?p='+principal+'&r='+rate+'&t='+duration+'&type='+monthOrYear+'&cType='+compoundingFreq).success(function(response){
...
$scope.rd = function(principal,rate,duration,monthOrYear,compoundingFreq){
  $http.get('http://ec2-34-216-106-44.us-west-2.compute.amazonaws.com:8080/v1/rd?p='+principal+'&r='+rate+'&t='+duration+'&type='+monthOrYear+'&cType='+compoundingFreq).success(function(response){
...
$scope.pincodeDetail = function(pincode){
  $http.get('http://ec2-34-216-106-44.us-west-2.compute.amazonaws.com:8080/v1/pincode?pincode='+pincode).success(function(response){
